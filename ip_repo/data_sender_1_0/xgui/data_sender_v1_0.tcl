...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M00_AXIS_TDATA_DEPTH"

}

proc update_PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH { PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH } {
	# Procedure called to update C_M00_AXIS_TDATA_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH { PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH } {
	# Procedure called to validate C_M00_AXIS_TDATA_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_AXIS_TDATA_DEPTH { MODELPARAM_VALUE.C_M00_AXIS_TDATA_DEPTH PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_AXIS_TDATA_DEPTH}] ${MODELPARAM_VALUE.C_M00_AXIS_TDATA_DEPTH}
}
