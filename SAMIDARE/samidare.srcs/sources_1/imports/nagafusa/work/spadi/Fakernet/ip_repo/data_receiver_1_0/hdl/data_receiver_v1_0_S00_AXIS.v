...
//	          if (S_AXIS_TVALID)
	...
	assign axis_tready = ((mst_exec_state == WRITE) && (write_pointer <= NUMBER_OF_INPUT_WORDS-1));
...
//                            send_counter <= send_counter+1;
                            send_counter <= send_counter+S_AXIS_TVALID;
//                            data_length <= data_length + 11'd1;
                            data_length <= data_length + S_AXIS_TVALID;
//                            event_offset_r <= data_length[9:0] + 10'd1;      // 
                            event_offset_r <= data_length[9:0] + S_AXIS_TVALID;      // 
//                            event_write_r <= 1'b1;
                            event_write_r <= S_AXIS_TVALID;
                            event_commit_r <= 1'b0;
                            event_commit_len_r <= 11'b0;
                            event_word_r <= S_AXIS_TDATA;
