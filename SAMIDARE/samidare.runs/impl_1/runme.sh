...
HD_PWD='/home/claudio/Developer/Vivado/SAMIDARE_DAQ/SAMIDARE/samidare.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_block_wrapper.tcl -notrace
