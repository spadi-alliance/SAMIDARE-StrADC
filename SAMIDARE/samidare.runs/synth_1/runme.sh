...
HD_PWD='/home/claudio/Developer/Vivado/SAMIDARE_DAQ/SAMIDARE/samidare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_block_wrapper.tcl
