...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_SAMPA_REG_TEST" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_SAMPA_REG_TEST { PARAM_VALUE.C_SAMPA_REG_TEST } {
	# Procedure called to update C_SAMPA_REG_TEST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_SAMPA_REG_TEST { PARAM_VALUE.C_SAMPA_REG_TEST } {
	# Procedure called to validate C_SAMPA_REG_TEST
	return true
}


proc update_MODELPARAM_VALUE.C_SAMPA_REG_TEST { MODELPARAM_VALUE.C_SAMPA_REG_TEST PARAM_VALUE.C_SAMPA_REG_TEST } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_SAMPA_REG_TEST}] ${MODELPARAM_VALUE.C_SAMPA_REG_TEST}
}
